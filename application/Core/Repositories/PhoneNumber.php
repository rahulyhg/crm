...
class PhoneNumber extends \Core\Core\ORM\Repositories\RDB
{
                ...
                if (!empty($phoneNumberValue)) {
                    if ($phoneNumberValue !== $entity->getFetched('phoneNumber')) {
                        ...
                        if (!$phoneNumberNew) {
                            ...
                            $defaultType = $this->getEntityManager()->getCoreMetadata()->get('entityDefs.' .  $entity->getEntityName() . '.fields.phoneNumber.defaultType');
