...
namespace Core\Core\SelectManagers;

use \Core\Core\Exceptions\Error;
use \Core\Core\Exceptions\Forbidden;

use \Core\Core\Acl;
use \Core\Core\AclManager;
...
class Base
{
    ...
    public function __construct($entityManager, \Core\Entities\User $user, Acl $acl, AclManager $aclManager, Metadata $metadata, Config $config)
    {
