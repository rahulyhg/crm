...
abstract class Base
{
    ...
    public function __construct(\Core\Core\Container $container, \Core\Core\Upgrades\ActionManager $actionManager)
    {
        $this->container = $container;
        $this->actionManager = $actionManager;
        $this->params = $actionManager->getParams();

        $this->zipUtil = new \Core\Core\Utils\File\ZipArchive($container->get('fileManager'));
    }
