...
namespace Core\Core\Utils\Database\Schema;
...
class Schema
{
    ...
    protected $drivers = array(
        'mysqli' => '\Core\Core\Utils\Database\DBAL\Driver\Mysqli\Driver',
        'pdo_mysql' => '\Core\Core\Utils\Database\DBAL\Driver\PDOMySql\Driver',
    );

    protected $fieldTypePaths = array(
        'application/Core/Core/Utils/Database/DBAL/FieldTypes',
        'custom/Core/Custom/Core/Utils/Database/DBAL/FieldTypes',
    );
    ...
    protected $rebuildActionsPath = array(
        'corePath' => 'application/Core/Core/Utils/Database/Schema/rebuildActions',
        'customPath' => 'custom/Core/Custom/Core/Utils/Database/Schema/rebuildActions',
    );
    ...
    public function __construct(\Core\Core\Utils\Config $config, \Core\Core\Utils\Metadata $metadata, \Core\Core\Utils\File\Manager $fileManager, \Core\Core\ORM\EntityManager $entityManager, \Core\Core\Utils\File\ClassParser $classParser, \Core\Core\Utils\Metadata\OrmMetadata $ormMetadata)
    {
        $this->config = $config;
        ...
        $this->comparator = new \Core\Core\Utils\Database\DBAL\Schema\Comparator();
        $this->initFieldTypes();
