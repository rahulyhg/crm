...
class Converter
{
    ...
    protected $tablePaths = array(
        'corePath' => 'application/Core/Core/Utils/Database/Schema/tables',
        'modulePath' => 'application/Core/Modules/{*}/Core/Utils/Database/Schema/tables',
        'customPath' => 'custom/Core/Custom/Core/Utils/Database/Schema/tables',
    );
    ...
    protected function getSchema($reload = false)
    {
        if (!isset($this->dbalSchema) || $reload) {
            $this->dbalSchema = new \Core\Core\Utils\Database\DBAL\Schema\Schema();
        }
    ...
    /**
     * Get custom table defenition in "application/Core/Core/Utils/Database/Schema/tables/" and in metadata 'additionalTables'
     *
     * @param  array  $ormMeta
     *
     * @return array
