...
class RelationManager
{
    ...
    public function __construct(\Core\Core\Utils\Metadata $metadata)
    {
    ...
    protected function getRelationClass($relationName)
    {
        ...
        $className = '\Core\Custom\Core\Utils\Database\Orm\Relations\\'.$relationName;
        if (!class_exists($className)) {
            $className = '\Core\Core\Utils\Database\Orm\Relations\\'.$relationName;
        }
