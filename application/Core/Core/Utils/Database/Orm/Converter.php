...
namespace Core\Core\Utils\Database\Orm;
...
class Converter
{
    ...
    */
    ...
    /**
     * Metadata conversion from Core format into Doctrine
     *
    ...
    /**
     * Correct fields defenitions based on \Core\Custom\Core\Utils\Database\Orm\Fields
     *
     * @param  array  $ormMeta
     *
     * @return array
    ...
    protected function correctFields($entityName, array $ormMeta)
    {
        ...
        foreach ($entityMeta['fields'] as $fieldName => $fieldParams) {
            ...
            $className = '\Core\Custom\Core\Utils\Database\Orm\Fields\\' . $fieldType;
            if (!class_exists($className)) {
                $className = '\Core\Core\Utils\Database\Orm\Fields\\' . $fieldType;
            }
