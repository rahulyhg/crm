...
class Layout
{
    ...
    protected $params = array(
        'defaultsPath' => 'application/Core/Core/defaults',
    );
    ...
    protected $paths = array(
        'corePath' => 'application/Core/Resources/layouts',
        'modulePath' => 'application/Core/Modules/{*}/Resources/layouts',
        'customPath' => 'custom/Core/Custom/Resources/layouts',
    );


    public function __construct(\Core\Core\Utils\File\Manager $fileManager, \Core\Core\Utils\Metadata $metadata, \Core\Entities\User $user)
    {
    ...
    public function resetToDefault($scope, $name)
    {
        ...
        $filePath = 'custom/Core/Custom/Resources/layouts/' . $scope . '/' . $name . '.json';
