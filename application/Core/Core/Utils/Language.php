...
class Language
{
    ...
    private $paths = array(
        'corePath' => 'application/Core/Resources/i18n',
        'modulePath' => 'application/Core/Modules/{*}/Resources/i18n',
        'customPath' => 'custom/Core/Custom/Resources/i18n',
    );
    ...
    public function __construct($language = null, File\Manager $fileManager, Metadata $metadata, $useCache = false, $noCustom = false)
    {
        ...
        $this->unifier = new \Core\Core\Utils\File\Unifier($this->fileManager, $this->metadata);
    }
