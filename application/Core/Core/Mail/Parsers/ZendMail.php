...
namespace Core\Core\Mail\Parsers;
...
class ZendMail
{
    ...
    public function fetchContentParts(\Core\Entities\Email $email, $message)
    {
        $zendMessage = $message->getZendMessage();
    ...
    protected function importPartDataToEmail(\Core\Entities\Email $email, $part, &$inlineIds = array(), $defaultContentType = null)
    {
        try {
            $type = null;
