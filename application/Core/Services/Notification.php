...
class Notification extends \Core\Services\Record
{
    ...
    public function notifyAboutNote(array $userIdList, \Core\Entities\Note $note)
    {
    ...
    public function checkUserNoteAccess(\Core\Entities\User $user, \Core\Entities\Note $note)
    {
