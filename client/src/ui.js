...
Core.define('ui', [], function () {
    ...
    var Ui = Core.Ui = Core.ui = {
        ...
        warning: function (message) {
            Core.Ui.notify(message, 'warning', 2000);
        },

        success: function (message) {
            Core.Ui.notify(message, 'success', 2000);
        },

        error: function (message) {
            Core.Ui.notify(message, 'error', 2000);
        },

        info: function (message) {
            Core.Ui.notify(message, 'info', 2000);
        },
    }
