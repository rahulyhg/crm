...
var Core = Core || {classMap:{}};

(function (Core, _, $) {

    var root = this;

    Core.Loader = function (cache, cacheTimestamp) {
    ...
    _.extend(Core.Loader.prototype, {
    ...
    Core.loader = new Core.Loader();
    Core.require = function (subject, callback, context, errorCallback) {
        if (context) {
            callback = callback.bind(context);
        }
        Core.loader.require(subject, callback, errorCallback);
    }
    Core.define = function (subject, dependency, callback) {
        Core.loader.define(subject, dependency, callback);
    }
    Core.loadLib = function (url, callback) {
        Core.loader.loadLib(url, callback);
    }
