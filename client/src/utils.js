    ...
    var Utils = Core.utils = Core.Utils = {
        ...
        convert: function (string, p) {
            ...
            switch (p) {
                case 'c-h':
                case 'C-h':
                    result = Core.Utils.camelCaseToHyphen(string);
                    break;
                case 'h-c':
                    result = Core.Utils.hyphenToCamelCase(string);
                    break;
                case 'h-C':
                    result = Core.Utils.hyphenToUpperCamelCase(string);
                    break;
            }
            return result;
        },
        ...
        toDom: function (string) {
            return Core.Utils.convert(string, 'c-h').split('.').join('-');
        },
