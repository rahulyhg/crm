...
Core.define('controller', [], function () {
    ...
    _.extend(Controller.prototype, {
        ...
        handleAccessGlobal: function () {
            if (!this.checkAccessGlobal()) {
                throw new Core.Exceptions.AccessDenied("Denied access to '" + this.name + "'");
            }
        },
        ...
        handleCheckAccess: function (action) {
            if (!this.checkAccess(action)) {
                ...
                throw new Core.Exceptions.AccessDenied(msg);
            }
        },
        ...
        doAction: function (action, options) {
            ...
            var method = action;
            if (!(method in this)) {
                throw new Core.Exceptions.NotFound("Action '" + this.name + "#" + action + "' is not found");
            }

            var preMethod = 'before' + Core.Utils.upperCaseFirst(method);
            var postMethod = 'after' + Core.Utils.upperCaseFirst(method);
