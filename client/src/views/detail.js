...
Core.define('views/detail', 'views/main', function (Dep) {
    ...
    return Dep.extend({
        ...
        actionSelectRelated: function (data) {
            ...
            var filters = Core.Utils.cloneDeep(this.selectRelatedFilters[link]) || {};
            ...
            var boolFilterList = dataBoolFilterList || Core.Utils.cloneDeep(this.selectBoolFilterLists[link] || []);
