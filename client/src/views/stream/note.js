...
Core.define('views/stream/note', 'view', function (Dep) {
    ...
    return Dep.extend({
        ...
        translateEntityType: function (entityType, isPlural) {
            ...
            if (~['de_DE', 'nl_NL'].indexOf(language)) {
                string = Core.Utils.upperCaseFirst(string);
            }
            return string;
        },
        ...
        getAvatarHtml: function () {
            ...
            return '<img class="avatar img-circle" width="20" src="'+this.getBasePath()+'?entryPoint=avatar&size=small&id=' + id + '&t='+t+'">';
        }
