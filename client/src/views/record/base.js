...
Core.define('views/record/base', ['view', 'view-record-helper', 'dynamic-logic'], function (Dep, ViewRecordHelper, DynamicLogic) {
    ...
    return Dep.extend({
        ...
        save: function (callback) {
            ...
            data = _.extend(Core.Utils.cloneDeep(beforeSaveAttributes), data);
        ...
        _doDependencyAction: function (data) {
            ...
            var methodName = 'dependencyAction' + Core.Utils.upperCaseFirst(action);
