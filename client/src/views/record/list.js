...
Core.define('views/record/list', 'view', function (Dep) {
    ...
    return Dep.extend({
        ...
        events: {
            ...
            'click .actions a.mass-action': function (e) {
                ...
                var method = 'massAction' + Core.Utils.upperCaseFirst(action);
                if (method in this) {
                	this[method]();
                } else {
        ...
        massAction: function (name) {
            ...
            var proceed = function () {
                ...
                Core.Ui.notify(this.translate(waitMessage, 'messages', this.scope));
                	...
                	if (this.allResultIsChecked) {
                		if (count) {
                			...
                			this.listenToOnce(this.collection, 'sync', function () {
                				...
                				Core.Ui.success(this.translate(msg, 'messages').replace('{count}', count));
                			}, this);
                			this.collection.fetch();
                			Core.Ui.notify(false);
                		} else {
                			Core.Ui.warning(self.translate('noRecordsRemoved', 'messages'));
                		}
                	} else {
	                    ...
	                    if (count) {
	                        ...
	                        Core.Ui.success(self.translate(msg, 'messages').replace('{count}', count));
	                    } else {
	                        Core.Ui.warning(self.translate('noRecordsRemoved', 'messages'));
	                    }
	                }
            ...
            this.confirm({
                ...
                this.ajaxPostRequest(this.entityType + '/action/massFollow', {
                    ...
                    if (resultCount) {
                        ...
                        Core.Ui.success(this.translate(msg, 'messages').replace('{count}', resultCount));
                    } else {
                        Core.Ui.warning(this.translate('massFollowZeroResult', 'messages'));
                    }
                }.bind(this));
            }, this);
        },
            ...
            this.confirm({
                ...
                this.ajaxPostRequest(this.entityType + '/action/massUnfollow', {
                    ...
                    if (resultCount) {
                        ...
                        Core.Ui.warning(this.translate('massUnfollowZeroResult', 'messages'));
                    }
                }.bind(this));
            }, this);
        },
                ...
                view.once('after:update', function (count) {
                    ...
                    this.listenToOnce(this.collection, 'sync', function () {
                        if (count) {
                            ...
                            Core.Ui.warning(this.translate('noRecordsUpdated', 'messages'));
                        }
                        if (allResultIsChecked) {
                        	this.selectAllResult();
	                    } else {
        ...
        setup: function () {
            ...
            this.events = Core.Utils.clone(this.events);
            this.massActionList = Core.Utils.clone(this.massActionList);
            this.buttonList = Core.Utils.clone(this.buttonList);
        ...
        buildRow: function (i, model, callback) {
            ...
            this.getInternalLayout(function (internalLayout) {
                internalLayout = Core.Utils.cloneDeep(internalLayout);
