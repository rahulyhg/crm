...
Core.define('views/record/search', 'view', function (Dep) {
    ...
    return Dep.extend({
        ...
        setup: function () {
            ...
            this.boolFilterList = Core.Utils.clone(this.getMetadata().get('clientDefs.' + this.scope + '.boolFilterList') || []);
            ...
            this.presetFilterList = Core.Utils.clone(this.getMetadata().get('clientDefs.' + this.scope + '.filterList') || []);
        ...
        getPresetData: function () {
            ...
            this.getPresetFilterList().forEach(function (item) {
                if (item.name == this.presetName) {
                    data = Core.Utils.clone(item.data || {});
                    return;
                }
            }, this);
            return data;
        ...
        loadSearchData: function () {
            ...
            if (this.presetName) {
                this.advanced = _.extend(Core.Utils.clone(this.getPresetData()), searchData.advanced);

                this.primary = this.getPrimaryFilterName();
            } else {
                this.advanced = Core.Utils.clone(searchData.advanced);
            }
