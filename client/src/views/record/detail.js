...
Core.define('views/record/detail', ['views/record/base', 'view-record-helper'], function (Dep, ViewRecordHelper) {
    ...
    return Dep.extend({
        ...
        actionSelfAssign: function () {
            ...
            this.model.save(attributes, {
                ...
                Core.Ui.success(this.translate('Self-Assigned'));
            }.bind(this));
        },
        ...
        getFieldViews: function (withHidden) {
            ...
            if (this.hasView('middle')) {
                if ('getFieldViews' in this.getView('middle')) {
                    _.extend(fields, Core.Utils.clone(this.getView('middle').getFieldViews(withHidden)));
                }
            }
            if (this.hasView('side')) {
        ...
        setup: function () {
            ...
            this.id = Core.Utils.toDom(this.entityType) + '-' + Core.Utils.toDom(this.type) + '-' + this.numId;
        ...
        exit: function (after) {
            ...
            if (this.returnUrl) {
                ...
                if (after) {
                    var methodName = 'exitAfter' + Core.Utils.upperCaseFirst(after);
