...
Core.define('views/email-account/fields/test-connection', 'views/fields/base', function (Dep) {
    ...
    return Dep.extend({
        ...
        test: function () {
            ...
            $.ajax({
                ...
                $btn.removeClass('disabled');
                Core.Ui.success(this.translate('connectionIsOk', 'messages', 'EmailAccount'));
            }.bind(this));
