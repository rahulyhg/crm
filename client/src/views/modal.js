...
Core.define('views/modal', 'view', function (Dep) {
    ...
    return Dep.extend({
        ...
        init: function () {
            ...
            this.buttonList = Core.Utils.cloneDeep(this.buttonList);

            // TODO remove it as depricated
            this.buttons = Core.Utils.cloneDeep(this.buttons);
            ...
            this.on('render', function () {
                ...
                this.buttonList.forEach(function (item) {
                    ...
                    o.onClick = o.onClick || (this['action' + Core.Utils.upperCaseFirst(o.name)] || function () {}).bind(this);
                ...
                this.dialog = new Core.Ui.Dialog({
