...
Core.define('views/preferences/fields/language', 'views/fields/enum', function (Dep) {

    return Dep.extend({

        setupOptions: function () {
            this.params.options = Core.Utils.clone(this.getConfig().get('languageList')).sort(function (v1, v2) {
