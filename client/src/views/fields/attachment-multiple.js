...
Core.define('views/fields/attachment-multiple', 'views/fields/base', function (Dep) {
    ...
    return Dep.extend({
        ...
        setup: function () {
            ...
            this.sourceList = Core.Utils.clone(this.params.sourceList || []).filter(function (item) {
