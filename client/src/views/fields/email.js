...
Core.define('views/fields/email', 'views/fields/varchar', function (Dep) {
    ...
    return Dep.extend({
        ...
        data: function () {
            ...
            if (this.mode == 'edit') {
                emailAddressData = Core.Utils.clone(this.model.get(this.dataFieldName));
        ...
        events: {
            ...
            'click [data-action="addEmailAddress"]': function () {
                var data = Core.Utils.cloneDeep(this.fetchEmailAddressData());
