...
Core.define('views/fields/array', ['views/fields/base', 'lib!Selectize'], function (Dep) {
    ...
    return Dep.extend({
        ...
        setup: function () {
            ...
            this.listenTo(this.model, 'change:' + this.name, function () {
                this.selected = Core.Utils.clone(this.model.get(this.name)) || [];
            }, this);
        ...
        setOptionList: function (optionList) {
            ...
            this.params.options = Core.Utils.clone(optionList);
        ...
        resetOptionList: function () {
            if (this.originalOptionList) {
                this.params.options = Core.Utils.clone(this.originalOptionList);
            }
        ...
        fetch: function () {
            var data = {};
            data[this.name] = Core.Utils.clone(this.selected || []);
            return data;
        },
