...
Core.define('views/fields/link-multiple', 'views/fields/base', function (Dep) {
    ...
    return Dep.extend({
        ...
        setup: function () {
            ...
            if (this.mode == 'search') {
                this.nameHash = Core.Utils.clone(this.searchParams.nameHash) || {};
                this.ids = Core.Utils.clone(this.searchParams.value) || [];
            }
