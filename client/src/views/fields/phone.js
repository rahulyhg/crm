...
Core.define('views/fields/phone', 'views/fields/varchar', function (Dep) {
    ...
    return Dep.extend({
        ...
        data: function () {
            var phoneNumberData;
            if (this.mode == 'edit') {
                phoneNumberData = Core.Utils.cloneDeep(this.model.get(this.dataFieldName));
        ...
        events: {
            ...
            'click [data-action="addPhoneNumber"]': function () {
                var data = Core.Utils.cloneDeep(this.fetchPhoneNumberData());
