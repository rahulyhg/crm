...
Core.define('views/email/fields/from-address-varchar', 'views/fields/varchar', function (Dep) {
        ...
        createPerson: function (scope, address) {
            ...
            this.createView('create', viewName, {
                ...
                this.listenTo(view, 'after:save', function (model) {
                    var nameHash = Core.Utils.clone(this.model.get('nameHash') || {});
                    var typeHash = Core.Utils.clone(this.model.get('typeHash') || {});
                    var idHash = Core.Utils.clone(this.model.get('idHash') || {});
