...
Core.define('views/dashlets/options/base', ['views/modal', 'views/record/detail', 'model', 'view-record-helper'], function (Dep, Detail, Model, ViewRecordHelper) {
    ...
    return Dep.extend({
        ...
        init: function () {
            ...
            this.fields = Core.Utils.cloneDeep(this.options.fields);
