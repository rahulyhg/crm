...
Core.define('views/admin/entity-manager/modals/edit-entity', ['views/modal', 'model'], function (Dep, Model) {
        ...
        actionSave: function () {
            ...
            $.ajax({
                ...
                if (this.scope) {
                    ...
                    Core.Ui.success(this.translate('entityCreated', 'messages', 'EntityManager'));
                }
