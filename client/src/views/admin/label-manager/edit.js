...
Core.define('views/admin/label-manager/edit', 'view', function (Dep) {
    ...
    return Dep.extend({
        ...
        setup: function () {
            ...
            this.ajaxPostRequest('LabelManager/action/getScopeData', {
                ...
                this.scopeDataInitial = Core.Utils.cloneDeep(this.scopeData);
                this.wait(false);
            }.bind(this));
        },
        ...
        actionSave: function () {
            ...
            Core.Ui.notify(this.translate('saving', 'messages'));
        ...
        actionCancel: function () {
            this.scopeData = Core.Utils.cloneDeep(this.scopeDataInitial);
            this.dirtyLabelList = [];
            this.setConfirmLeaveOut(false);
