...
Core.define('views/admin/layouts/rows', 'views/admin/layouts/base', function (Dep) {
    ...
    return Dep.extend({
        ...
        events: _.extend({
            'click #layout a[data-action="editField"]': function (e) {
                ...
                this.dataAttributeList.forEach(function (attr) {
                    data[attr] =  $(e.target).closest('li').data(Core.Utils.toDom(attr))
                });
        ...
        fetch: function () {
            ...
            $("#layout ul.enabled > li").each(function (i, el) {
                var o = {};
                this.dataAttributeList.forEach(function (attr) {
                    var value = $(el).data(Core.Utils.toDom(attr)) || null;
                    if (value) {
                        o[attr] = value;
                    }
                });
