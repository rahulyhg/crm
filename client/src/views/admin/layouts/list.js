...
Core.define('views/admin/layouts/list', 'views/admin/layouts/rows', function (Dep) {
    ...
    return Dep.extend({
        ...
        loadLayout: function (callback) {
            this.getModelFactory().create(Core.Utils.hyphenToUpperCamelCase(this.scope), function (model) {
