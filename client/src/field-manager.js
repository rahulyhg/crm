 ...
 Core.define('field-manager', [], function () {
    ...
    _.extend(FieldManager.prototype, {
                ...
                if ('actualFields' in this.defs[fieldType]) {
                    ...
                    if (naming == 'prefix') {
                        actualfFields.forEach(function (f) {
                            fieldNames.push(f + Core.Utils.upperCaseFirst(fieldName));
                        });
                    } else {
                        actualfFields.forEach(function (f) {
                            fieldNames.push(fieldName + Core.Utils.upperCaseFirst(f));
                        });
                    }
                } else {
        ...
        getViewName: function (fieldType) {
            ...
            return 'views/fields/' + Core.Utils.camelCaseToHyphen(fieldType);
        },
