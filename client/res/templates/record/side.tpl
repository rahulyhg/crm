{{#each panelList}}
<div class="panel panel-{{#if style}}{{style}}{{else}}success{{/if}} panel-{{name}}{{#if hidden}} hidden{{/if}}{{#if sticked}} sticked{{/if}}" data-name="{{name}}" data-name="{{name}}">
    {{#if label}}
    <div class="panel-heading">
        <div class="pull-right btn-group" style="background-color:transparent;">
            {{#if buttonList}}
                {{#each buttonList}}
            ...
            {{/if}}
            {{#if actionList}}
                <button type="button" class="btn btn-{{#if style}}{{style}}{{else}}default{{/if}} btn-sm dropdown-toggle" data-toggle="dropdown" style="background-color:transparent;">
        ...
        <h4 class="panel-title">
            <span class="panel-icon" style="margin-left: -10px; margin-right: -10px;">
