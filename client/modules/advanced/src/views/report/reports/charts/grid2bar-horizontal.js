...
Core.define('Advanced:Views.Report.Reports.Charts.Grid2BarHorizontal', 'Advanced:Views.Report.Reports.Charts.Grid2BarVertical', function (Dep) {
    ...
    return Dep.extend({
        ...
        prepareData: function () {
            ...
            var firstList = this.firstList = Core.Utils.clone(result.grouping[0]);
