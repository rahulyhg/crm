...
Core.define('crm:views/record/panels/activities', ['views/record/panels/relationship', 'multi-collection'], function (Dep, MultiCollection) {
    ...
    return Dep.extend({
        ...
        setup: function () {
            ...
            this.listLayout = Core.Utils.cloneDeep(this.listLayout);
            this.actionList = Core.Utils.cloneDeep(this.actionList);
