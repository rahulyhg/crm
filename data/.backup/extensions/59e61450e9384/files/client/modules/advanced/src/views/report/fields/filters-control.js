...
Core.define('Advanced:Views.Report.Fields.FiltersControl', 'Views.Fields.Base', function (Dep) {
    ...
    return Dep.extend({
        ...
        setup: function () {
            ...
            this.listenTo(this.model, 'change:filters', function () {
                ...
                var previousFilterList = Core.Utils.clone(this.filterList);
                var toAdd = [];
                var toRemove = [];
                this.setupFiltersData();
        ...
        setupFiltersData: function () {
            this.filterList = Core.Utils.clone(this.model.get('filters')) || [];
        },
        ...
        removeFilter: function (name) {
            ...
            this.$el.find('.filters-row .filter-' + Core.Utils.toDom(name)).remove();
        },
